...
SECRET_KEY = 'django-insecure-(u$&ed23xc5zt(!4#k7jdxbhfbdp6c6ak0n8%)ds%ob@-s=+ju'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            '/Users/harsha/Projects/registrationform/templates',
            '/Users/harsha/Projects/registrationform/registrationformapp/templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
